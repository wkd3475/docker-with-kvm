...
client.get("http://localhost:"+PORT_NUM1+"/api/io/"+LOAD_STRENGTH, (data, response) => {
    let obj = {};
...
client.get("http://localhost:"+PORT_NUM2+"/api/io/"+LOAD_STRENGTH, (data, response) => {
    let obj = {};
...
client.get("http://localhost:"+PORT_NUM3+"/api/io/"+LOAD_STRENGTH, (data, response) => {
    let obj = {};
...
client.get("http://localhost:"+PORT_NUM4+"/api/io/"+LOAD_STRENGTH, (data, response) => {
    let obj = {};
